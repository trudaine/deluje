            ...
            if (SwingTopBarPanel.isAffectEntireActive && paramName != null) {
              org.deluge.model.ProjectModel projectModel =
                  SwingDelugeApp.mainInstance != null
                      ...
                      : null;
              if (projectModel != null) {
                org.deluge.model.TrackModel curTrack = projectModel.getTracks().get(trackIndex);
                int drumIdx = tabs.getSelectedIndex();
                if (drumIdx >= 0 && curTrack instanceof org.deluge.model.KitTrackModel curKit) {
                  org.deluge.model.Drum curDrum = curKit.getDrums().get(drumIdx);
                  ...
                  if (curVal != null) {
                    ...
                    java.util.List<org.deluge.model.Drum> drums = curKit.getDrums();
