...
public class HelpTextManager {
  ...
  static {
    DICTIONARY.put(
        "LEVEL", "Track Volume Level. [GLOBAL] Controls the global volume dynamics of the track.");
    DICTIONARY.put(
        "PAN", "Track step Panning modulation. [PER STEP] Automation and drawing supported.");
    DICTIONARY.put(
        "PITCH",
        "Track step active transposition. [PER STEP] Step pitch transpose values assignments.");
    DICTIONARY.put(
        "FILTER",
        "Low-pass filter Cutoff frequency. [PER STEP] Live automation dynamic drawing supported.");
    ...
    DICTIONARY.put(
        "TRANSPOSE", "Track global scale pitch transpose. [GLOBAL] Dynamic pitch shift values.");
  }
  ...
  public static String getHelp(String label) {
    ...
    return DICTIONARY.getOrDefault(
        match, "Dynamic sequencer parameter live assignment onboarding tutorial checks.");
  }
}
