...
public class GateDrum extends Drum {
  ...
  public void setGateType(GateType v) {
    this.gateType = v;
  }

  public float getTriggerDurationMs() {
    return triggerDurationMs;
  }

  public void setTriggerDurationMs(float v) {
    this.triggerDurationMs = Math.max(0.1f, v);
  }
  ...
  public void setPolarity(Polarity v) {
    this.polarity = v;
  }
  ...
  public void setPulseWidthMs(float v) {
    this.pulseWidthMs = Math.max(0.1f, v);
  }
}
