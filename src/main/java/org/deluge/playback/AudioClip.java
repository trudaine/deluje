...
import org.deluge.firmware2.Envelope;
...
public class AudioClip extends Clip {
  ...
  private org.deluge.firmware2.Sample fw2SampleCache;
  private final org.deluge.firmware2.VoiceSample voiceSample =
      new org.deluge.firmware2.VoiceSample();
  ...
  public void render(StereoSample[] buffer, int numSamples, int phaseIncrement) {
    ...
    if (fw2SampleCache == null) {
      fw2SampleCache = org.deluge.firmware2.Sample.fromFirmwareSample(sample);
