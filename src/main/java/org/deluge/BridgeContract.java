...
public final class BridgeContract {
  ...
  // Extracted to BridgeStepData.java

  // ───────────────────────────────────────────────────────────────────────
  //  TrackData — 13 arrays
  // ───────────────────────────────────────────────────────────────────────

  // Extracted to BridgeTrackData.java
  ...
  // Extracted to BridgeKitData.java

  // ───────────────────────────────────────────────────────────────────────
  //  AudioData — 6 arrays
  // ───────────────────────────────────────────────────────────────────────

  // Extracted to BridgeAudioData.java

  // ═══════════════════════════════════════════════════════════════════════
  //  Inner Data-Class Instances
  // ═══════════════════════════════════════════════════════════════════════

  private final BridgeStepData step = new BridgeStepData();
  private final BridgeTrackData track = new BridgeTrackData();
  private final BridgeKitData kit = new BridgeKitData();
  private final BridgeAudioData audio = new BridgeAudioData();
