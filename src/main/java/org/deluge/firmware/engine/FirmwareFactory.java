...
public class FirmwareFactory {
  ...
  private static void configureArp(
      org.deluge.firmware.engine.FirmwareSound sound, org.deluge.model.ArpModel arp) {
  ...
  private static org.deluge.firmware.model.PolyphonyMode toPolyphonyMode(
      SynthTrackModel.PolyphonyMode m) {
    if (m == null) return org.deluge.firmware.model.PolyphonyMode.POLY;
    try {
      return org.deluge.firmware.model.PolyphonyMode.valueOf(m.name());
    } catch (IllegalArgumentException e) {
      return org.deluge.firmware.model.PolyphonyMode.POLY;
    }
  }
    ...
    if (clipModel != null) {
      clip.sequenceDirectionMode =
          switch (clipModel.getPlayDirection()) {
            case FORWARD -> org.deluge.firmware.model.SequenceDirection.FORWARD;
            case REVERSE -> org.deluge.firmware.model.SequenceDirection.REVERSE;
            case PING_PONG -> org.deluge.firmware.model.SequenceDirection.PINGPONG;
            case RANDOM -> org.deluge.firmware.model.SequenceDirection.RANDOM;
          };
      if (clip.sequenceDirectionMode == org.deluge.firmware.model.SequenceDirection.REVERSE) {
