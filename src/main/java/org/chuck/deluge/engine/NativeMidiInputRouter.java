 ...
 *
 * <p>Uses {@link javax.sound.midi.MidiDevice} to enumerate and open MIDI input ports.
 * Receives note-on/off, CC, and pitch bend messages, routing them to voice triggers
 * in the engine via the {@link TickEventQueue}.
 *
 * <p>Matches the functionality of {@code MidiInputRouter} but without ChucK dependency.
 * When the Java engine is active, this replaces the ChucK-based MidiInputRouter.
 */
public class NativeMidiInputRouter {
    ...
    public NativeMidiInputRouter(BridgeContract bridge, TickEventQueue eventQueue, VoiceAllocator voiceAllocator) {
        this.bridge = bridge;
