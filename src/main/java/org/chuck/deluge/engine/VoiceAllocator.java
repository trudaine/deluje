 ...
 * <ul>
 *   <li>Per-track voice pools (configurable via {@link BridgeContract#G_POLYPHONY})</li>
 *   <li>Voice stealing (oldest note when pool exhausted)</li>
 *   <li>Three priority modes: newest, oldest, highest MIDI note</li>
 *   <li>First-available fallback (matches original behavior)</li>
 * </ul>
 *
 * <p>Voice slots are partitioned across tracks. Each slot holds a reference to its
 * owning voice (synth, sample, or DX7) and metadata for stealing decisions.
 */
public class VoiceAllocator {

    public enum Priority { NEWEST, OLDEST, HIGHEST_NOTE }
