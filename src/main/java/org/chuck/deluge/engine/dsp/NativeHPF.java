...
/**
 * Second-order Butterworth high-pass filter, matching the chuck-core {@code HPF} class in compute()
 * behavior.
 *
 * <p>Implements a standard biquad HPF with configurable cutoff and Q. Filter state (x1/x2/y1/y2)
 * persists across calls, matching the DSL behavior.
 */
public class NativeHPF {
   ...
   *
   * <p>Matches the DSL's HPF.compute() — standard biquad difference equation, no gain
   * multiplication.
   */
