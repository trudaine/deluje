...
/**
 * High-performance, pure Java implementation of the Deluge ADSR envelope.
 * Decoupled from ChucK-Java core.
 */
public class NativeAdsr {
    public enum State { IDLE, ATTACK, DECAY, SUSTAIN, RELEASE, FAST_RELEASE }
