    ...
    try {
      ...
      while (running) {
        try {
          ...
          if (blockCounter % 2000 == 0) {
            if (peak > 1000) {
              System.out.println("[JavaAudioDriver] LIVE SIGNAL PEAK (Q31): " + peak);
            }
            peak = 0;
          }
          blockCounter++;
          ...
          System.err.println("[JavaAudioDriver] CRITICAL ERROR IN AUDIO LOOP: " + t.getMessage());
          t.printStackTrace();
          break;
        }
      }
