...
public class BasicWaves {
  ...
  public static int[] getTableInfo(int phaseIncrement) {
    if (phaseIncrement <= 1247086) return new int[] {6, 11};
    if (phaseIncrement <= 1764571) return new int[] {6, 11};
    if (phaseIncrement <= 2494173) return new int[] {6, 11};
    if (phaseIncrement <= 3526245) return new int[] {6, 11};
    if (phaseIncrement <= 4982560) return new int[] {6, 11};
