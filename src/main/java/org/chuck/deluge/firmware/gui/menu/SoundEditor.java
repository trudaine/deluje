...
public class SoundEditor {
  public static Submenu createRootMenu(FirmwareSound sound) {
    ...
    oscA.addItem(new IntegerRangeMenuItem("VOLUME", 127, 0, 127, (v) -> {
    ...
    oscB.addItem(new IntegerRangeMenuItem("VOLUME", 0, 0, 127, (v) -> {
    ...
    filter.addItem(new IntegerRangeMenuItem("LPF FREQ", 64, 0, 127, (v) -> {
        sound.paramNeutralValues[Param.LOCAL_LPF_FREQ] = (int)(v * 16909320.0);
    }));
    filter.addItem(new IntegerRangeMenuItem("LPF RES", 0, 0, 127, (v) -> {
        sound.paramNeutralValues[Param.LOCAL_LPF_RESONANCE] = (int)(v * 16909320.0);
    }));
    filter.addItem(new IntegerRangeMenuItem("HPF FREQ", 0, 0, 127, (v) -> {
        sound.paramNeutralValues[Param.LOCAL_HPF_FREQ] = (int)(v * 16909320.0);
    }));
    root.addItem(filter);

    Submenu lfo = new Submenu("LFO");
    lfo.addItem(new IntegerRangeMenuItem("LFO1 RATE", 50, 0, 127, (v) -> {
        sound.paramNeutralValues[Param.LOCAL_LFO_LOCAL_FREQ_1] = (int)(v * 16909320.0);
    }));
    lfo.addItem(new IntegerRangeMenuItem("LFO2 RATE", 50, 0, 127, (v) -> {
