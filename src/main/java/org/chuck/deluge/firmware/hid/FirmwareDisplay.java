...
/**
 * Port of the Deluge's Display class.
 * Acts as a bridge between the bit-accurate firmware logic and the Swing UI.
 */
public class FirmwareDisplay {
    private static final FirmwareDisplay INSTANCE = new FirmwareDisplay();
    public static FirmwareDisplay get() { return INSTANCE; }
