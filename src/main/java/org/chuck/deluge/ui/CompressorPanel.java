  ...
  public CompressorPanel(
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (model.getCompressorAttack() * 100),
            val -> model.setCompressorAttack(val / 100f),
            "",
            "compAttack",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (model.getCompressorRelease() * 100),
            val -> model.setCompressorRelease(val / 100f),
            "",
            "compRelease",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (model.getCompressorRatio()),
            val -> model.setCompressorRatio(val),
            "",
            "compRatio",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (model.getCompressorBlend() * 100),
            val -> model.setCompressorBlend(val / 100f),
            "%",
            "compBlend",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (model.getCompressorSidechainHpf() * 100),
            val -> model.setCompressorSidechainHpf(val / 100f),
            "%",
            "compSidechainHpf",
            projectModel,
            trackIndex);
