...
public class CompressorPanel extends JPanel {
  ...
  public CompressorPanel(
    ...
    c.gridy = row;
    c.gridwidth = 3;
    add(SwingSynthConfigDialog.sectionLabel("TRACK COMPRESSOR"), c);
    row++;
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (bridge.getCompAttack(trackIndex) * 100),
            val -> bridge.setCompAttack(trackIndex, val / 100f),
            "",
            "compAttack",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (bridge.getCompRelease(trackIndex) * 100),
            val -> bridge.setCompRelease(trackIndex, val / 100f),
            "",
            "compRelease",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (bridge.getCompRatio(trackIndex)),
            val -> bridge.setCompRatio(trackIndex, val),
            "",
            "compRatio",
            projectModel,
            trackIndex);
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (bridge.getCompBlend(trackIndex) * 100),
            val -> bridge.setCompBlend(trackIndex, val / 100f),
            "%",
            "compBlend",
            projectModel,
            trackIndex);
    ...
    c.gridy = row;
    c.gridwidth = 3;
    add(SwingSynthConfigDialog.sectionLabel("SIDECHAIN HPF"), c);
    row++;
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            0,
            100,
            (int) (bridge.getCompSidechainHpf(trackIndex) * 100),
            val -> bridge.setCompSidechainHpf(trackIndex, val / 100f),
            "%",
            "compSidechainHpf",
            projectModel,
            trackIndex);
