...
import org.chuck.deluge.firmware.hid.VirtualOLED;

/**
 * Swing component that renders the high-fidelity VirtualOLED display.
 * Emulates the look of the hardware's 128x64 white-on-black OLED.
 */
