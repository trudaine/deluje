...
public class OscPanel extends JPanel {
  ...
  public OscPanel(SynthTrackModel model, BridgeContract bridge, int trackIndex, ProjectModel projectModel) {
    ...
    add(SwingSynthConfigDialog.sectionLabel("MIX"), c); row++;

    row = SwingSynthConfigDialog.addSlider(this, c, row, "Osc Mix:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Noise Vol:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Portamento:",
    ...
    c.gridx = 0; c.gridy = row; c.gridwidth = 3;
    add(SwingSynthConfigDialog.sectionLabel("OSCILLATOR 1 \u2014 SAMPLE PLAYBACK"), c); row++;
    ...
    // Time stretch amount
    row = SwingSynthConfigDialog.addSlider(this, c, row, "TS Amount:",
        ...
        "%", "osc1TsAmt", projectModel, trackIndex);

    // Cents
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Cents:",
    ...
    add(osc1LinBox, c); row++;

    // ── Oscillator 2 Sample Playback ──
    c.gridx = 0; c.gridy = row; c.gridwidth = 3;
    add(SwingSynthConfigDialog.sectionLabel("OSCILLATOR 2 \u2014 SAMPLE PLAYBACK"), c); row++;
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "TS Amount:",
        ...
        "%", "osc2TsAmt", projectModel, trackIndex);
    ...
    add(osc2LinBox, c); row++;

    // Transpose
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Transpose:",
    ...
    // ── Oscillator Sync ──
    c.gridx = 0; c.gridy = row; c.gridwidth = 3;
    add(SwingSynthConfigDialog.sectionLabel("OSCILLATOR SYNC"), c); row++;
