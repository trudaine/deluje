...
public class ArpPanel extends JPanel {
  ...
  public ArpPanel(SynthTrackModel model, BridgeContract bridge, int trackIndex, ProjectModel projectModel) {
    ...
    add(SwingSynthConfigDialog.sectionLabel("ARPEGGIATOR"), c); row++;
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Gate:",
    ...
    add(octModeCombo, c); row++;

    row = SwingSynthConfigDialog.addSlider(this, c, row, "Repeat:",
        "Repeat each step N times (1-8)",
        1, 8, bridge.getArpStepRepeat(trackIndex),
        val -> bridge.setArpStepRepeat(idx, val), "\u00d7", "arpStepRepeat",
        projectModel, trackIndex);

    row = SwingSynthConfigDialog.addSlider(this, c, row, "Rhythm:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Seq Len:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Oct Spread:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Gate Spread:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Vel Spread:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Ratchet:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Note Prob:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Chord Poly:",
    ...
    row = SwingSynthConfigDialog.addSlider(this, c, row, "Chord Prob:",
