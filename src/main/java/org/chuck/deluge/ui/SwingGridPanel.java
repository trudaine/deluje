...
public class SwingGridPanel extends JPanel {
  ...
  private static final String[] MACRO_TOOLTIPS = {
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>LEVEL (Col 0)</b><br>Volume/Gain parameter.<br>• <i>Left Knob:</i> Master Track Volume level (0.0 to 1.5 multiplier).<br>• <i>Right Knob:</i> Stereo Pan Position.<br>• <i>Kit Mode:</i> Selected Drum Lane Volume level.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>PAN (Col 1)</b><br>Stereo Pan Position / FX sends.<br>• <i>Left Knob:</i> Delay Send Level.<br>• <i>Right Knob:</i> Reverb Send Level.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>PITCH (Col 2)</b><br>Transpose / Tuning parameter.<br>• <i>Left Knob:</i> Transpose note pitch (-24 to +24 semitones).<br>• <i>Right Knob:</i> Fine Tune cents adjustments.<br>• <i>Kit Mode:</i> Selected Drum lane sample pitch semitones.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>FILTER / COARSE (Col 3)</b><br>Filter Cutoff / FM Coarse frequency ratio.<br>• <i>Left Knob:</i> Lowpass Filter Cutoff frequency (20Hz to 20kHz).<br>• <i>Right Knob:</i> Lowpass Filter Resonance Q.<br>• <i>FM Mode:</i> Active Operator Coarse Frequency Ratio (0 to 31).</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>RESONANCE / LEVEL (Col 4)</b><br>Filter Resonance Q / FM Operator Level.<br>• <i>Left Knob:</i> Highpass Filter Cutoff frequency (20Hz to 20kHz).<br>• <i>Right Knob:</i> Highpass Filter Resonance Q.<br>• <i>FM Mode:</i> Active Operator Output Level amplitude (0 to 99) and Detune.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>OSC1 / EG RATES (Col 5)</b><br>Osc A volume / FM EG Rates.<br>• <i>Left Knob:</i> Oscillator A relative volume mix.<br>• <i>FM Mode:</i> Active Operator Envelope Rates (Rate 1 - Rate 4).<br>• <i>Kit Mode:</i> Selected Lane sample playback start offset.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>OSC2 / EG LEVELS (Col 6)</b><br>Noise volume / FM EG Levels.<br>• <i>Left Knob:</i> White noise generator level.<br>• <i>FM Mode:</i> Active Operator Envelope Levels (Level 1 - Level 4).<br>• <i>Kit Mode:</i> Selected Lane sample release envelope speed.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>LFO (Col 7)</b><br>LFO modulation frequency rates.<br>• <i>Left Knob:</i> LFO 1 Frequency Speed rate (0.0Hz to 20.0Hz).<br>• <i>Right Knob:</i> LFO 1 Modulation Depth amplitude.<br>• <i>FM Mode:</i> Global DX7 Pitch LFO Speed and modulation depth.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>MOD FX (Col 8)</b><br>Modulation Chorus / Flanger effects.<br>• <i>Left Knob:</i> Mod Chorus/Flanger LFO rate speed.<br>• <i>Right Knob:</i> Mod Chorus/Flanger Depth amplitude.<br>• <i>FM Mode:</i> FM Algorithm Matrix Selection (0-31) and operator feedback.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>DELAY (Col 9)</b><br>Tempo-synced Delay effects page.<br>• <i>Left Knob:</i> Delay Sync Time clock subdivision rate (e.g. 1/16).<br>• <i>Right Knob:</i> Delay Feedback regeneration repeats level.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>REVERB (Col 10)</b><br>Spatial Reverb send page.<br>• <i>Left Knob:</i> Reverb Room Size / Decay time.<br>• <i>Right Knob:</i> Reverb Highpass Damping frequency absorption.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>STUTTER (Col 11)</b><br>Real-time performance repeat stutter.<br>• <i>Left Knob:</i> Step repeater rate (0.0 to 1.0).<br>• <i>Kit Mode:</i> Master drum loop stutter gate rate.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>PROBABILITY (Col 12)</b><br>Step event trigger probability page.<br>• <i>Left Knob:</i> Adjusts active step trigger probability percentages (0% to 100%) globally for the current clip.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>GATE (Col 13)</b><br>Arpeggiator Gate / step duration parameters.<br>• <i>Left Knob:</i> Step note duration gate gate (0.0 to 2.0 multiplier) globally for the current clip.<br>• <i>Arp Mode:</i> Arpeggiator Gate duration and Octave Range (1-4).</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>VELOCITY (Col 14)</b><br>Step strike velocity page.<br>• <i>Left Knob:</i> Adjusts strike velocity input values (0.0 to 1.0) globally for the current clip.</body></html>",
    "<html><body style='font-size: 9px; font-family: sans-serif;'><b>SAMPLE / ARP RATE (Col 15)</b><br>Sample load menu / Arp Speed.<br>• <i>Left Knob:</i> Open sample swap browser dialog.<br>• <i>Synth Arp:</i> Adjusts Synth's active Arpeggiator Rate speed frequency multiplier (0.0 to 2.0).</body></html>"
  };
        ...
        switch (viewMode) {
            case CLIP:
              if (isAdvanced && colId < columnCount - 2) {
                ...
                clipBtn.addMouseListener(gestureCoordinator.createMouseAdapter(visibleRow, colId));
              } else {
