  ...
  public EqPanel(
    ...
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            -100,
            100,
            (int) (bridge.getEqBass(trackIndex) * 100),
            val -> bridge.setEqBass(trackIndex, val / 100f),
            "%",
            "eqBass",
            projectModel,
            trackIndex);
    row =
        SwingSynthConfigDialog.addSlider(
            ...
            -100,
            100,
            (int) (bridge.getEqTreble(trackIndex) * 100),
            val -> bridge.setEqTreble(trackIndex, val / 100f),
            "%",
            "eqTreble",
            projectModel,
            trackIndex);
