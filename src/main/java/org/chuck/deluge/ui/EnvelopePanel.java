...
public class EnvelopePanel extends JPanel {
  ...
  public EnvelopePanel(SynthTrackModel model, BridgeContract bridge, int trackIndex, ProjectModel projectModel) {
    ...
    for (int e = 0; e < 4; e++) {
      ...
      // ADSR sliders
      row = SwingSynthConfigDialog.addSlider(panel, c, row, "Attack:",
          ...
          "ms", "env" + envIdx + "Attack", projectModel, trackIndex);
      row = SwingSynthConfigDialog.addSlider(panel, c, row, "Decay:",
          ...
          "ms", "env" + envIdx + "Decay", projectModel, trackIndex);
      row = SwingSynthConfigDialog.addSlider(panel, c, row, "Sustain:",
          ...
          "%", "env" + envIdx + "Sustain", projectModel, trackIndex);
      row = SwingSynthConfigDialog.addSlider(panel, c, row, "Release:",
          ...
          "ms", "env" + envIdx + "Release", projectModel, trackIndex);
      ...
      // Amount
      row = SwingSynthConfigDialog.addSlider(panel, c, row, "Amount:",
          ...
          "%", "env" + envIdx + "Amount", projectModel, trackIndex);
