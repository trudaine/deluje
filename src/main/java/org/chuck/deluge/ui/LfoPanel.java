...
public class LfoPanel extends JPanel {
  ...
  private static final String[] SYNC_VALS = {"OFF", "1/1", "1/2", "1/4", "1/8", "1/16", "1/32", "1/64",
  ...
  public LfoPanel(ChuckVM vm, BridgeContract bridge, int trackIndex) {
    ...
    // Header row
    int col = 0;
    c.gridx = col++; c.gridy = 0; add(SwingSynthConfigDialog.label(""), c);
    c.gridx = col++; add(SwingSynthConfigDialog.headerLabel("SHAPE"), c);
    c.gridx = col++; add(SwingSynthConfigDialog.headerLabel("RATE"), c);
    c.gridx = col++; add(SwingSynthConfigDialog.headerLabel("DEPTH"), c);
    c.gridx = col++; add(SwingSynthConfigDialog.headerLabel("TARGET"), c);
    c.gridx = col++; add(SwingSynthConfigDialog.headerLabel("SYNC"), c);
    c.gridx = col;   add(SwingSynthConfigDialog.headerLabel("SCOPE"), c);
