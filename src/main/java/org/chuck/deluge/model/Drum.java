...
/**
 * Abstract base for all drum types on a Kit track. Holds synth-parity parameters
 * common to sample-based, MIDI, and gate-trigger drums.
 */
public abstract class Drum {
  ...
  public void setPitchSemitones(float v) { this.pitchSemitones = v; }

  public int getMuteGroup() { return muteGroup; }
  public void setMuteGroup(int v) { this.muteGroup = v; }

  public EnvelopeModel getAdsr() { return adsr; }
  public void setAdsr(EnvelopeModel v) { this.adsr = v; }

  public float getLpfFreq() { return lpfFreq; }
  public void setLpfFreq(float v) { this.lpfFreq = v; }

  public float getLpfRes() { return lpfRes; }
  public void setLpfRes(float v) { this.lpfRes = v; }
  ...
  public void setEnv3(EnvelopeModel v) { this.env3 = v; }

  public EnvelopeModel getEnv4() { return env4; }
  public void setEnv4(EnvelopeModel v) { this.env4 = v; }

  public LfoModel getLfo1() { return lfo1; }
  public void setLfo1(LfoModel v) { this.lfo1 = v; }

  public LfoModel getLfo2() { return lfo2; }
  public void setLfo2(LfoModel v) { this.lfo2 = v; }
