...
public class RoundtripDiagnostics {
  ...
  public void runRoundtrip() throws Exception {
    ...
    System.out.println("=== DIAGNOSTIC RUNNER: SERIALIZING REGENERATED SONG (STREAM 1) ===");
    ...
    System.out.println("=== DIAGNOSTIC RUNNER: SERIALIZING REGENERATED SONG (STREAM 2) ===");
    ProjectSerializer.save(model, regenFile2);
    System.out.println("=== DIAGNOSTIC RUNNER: REGENERATED SUCCESSFULLY TO ===");
