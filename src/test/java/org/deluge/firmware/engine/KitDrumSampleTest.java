...
class KitDrumSampleTest {
  ...
  private static org.deluge.firmware.model.sample.Sample sample(float[] wave) {
    org.deluge.firmware.model.sample.Sample s = new org.deluge.firmware.model.sample.Sample();
    s.data = wave;
    s.numChannels = 1;
    s.sampleRate = 44100f;
    return s;
