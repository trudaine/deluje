...
class PatchSourceLockstepTest {
  ...
  void patchSourceEnumsAreInLockstep() {
    ...
    for (var bridge : bridgeValues) {
      org.deluge.firmware2.PatchSource fw2 =
          org.deluge.firmware2.PatchSource.valueOf(bridge.name());
  ...
  void patchCablePolarityMappingHolds() {
    ...
    org.deluge.firmware2.Patcher.PatchCable fc2 = new org.deluge.firmware2.Patcher.PatchCable();
    fc2.polarity = org.deluge.firmware2.Patcher.PatchCable.BIPOLAR;
    assertEquals(
