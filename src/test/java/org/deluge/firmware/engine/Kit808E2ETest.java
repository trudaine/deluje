...
class Kit808E2ETest {
  ...
  private static org.deluge.firmware.model.sample.Sample makeSample(float freqHz) {
    int sr = 44100;
    int n = sr / 10; // 100ms
  ...
  private static void applySampleToDrum(
      FirmwareKit kit, int drumIdx, org.deluge.firmware.model.sample.Sample ms) {
  ...
  void distinctSamplesProduceDistinctKitDrumAudio() {
    ...
    var samples = new org.deluge.firmware.model.sample.Sample[4];
  ...
  void sampleSurvivesEngineRebuild() {
    ...
    originalDrum.oscTypes[0] = org.deluge.firmware2.Oscillator.OscType.SAMPLE;
    originalDrum.samples[0] = ms;
    originalDrum.fw2SampleCache[0] = org.deluge.firmware2.Sample.fromFirmwareSample(ms);
