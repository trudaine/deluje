...
public class Firmware2IntegrationTest {
  ...
  public void firmware2WiredIntoFirmwareSoundRendersAudio() {
    ...
    System.out.println(
        "paramKnobs[OSC_A]="
            + sound.paramKnobs[org.deluge.firmware2.Param.LOCAL_OSC_A_VOLUME]
            + " knob[VOL]="
            + sound.paramKnobs[org.deluge.firmware2.Param.LOCAL_VOLUME]
            + " knob[LPF]="
            + sound.paramKnobs[org.deluge.firmware2.Param.LOCAL_LPF_FREQ]);
