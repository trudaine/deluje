...
class TriggerRenderConsistencyTest {
  ...
  private static org.deluge.playback.Sample tone(float freqHz) {
    int sr = 44100;
    int n = sr / 10;
  ...
  void defaultDesktopBoostIsLoudButDoesNotHardClip() {
    ...
    s.paramNeutralValues[org.deluge.firmware2.Param.LOCAL_OSC_A_VOLUME] =
        org.deluge.firmware2.Functions.ONE_Q31
            / 4; // Turn down volume to prevent clipping when summing 4 notes
    s.paramNeutralValues[org.deluge.firmware2.Param.LOCAL_OSC_B_VOLUME] =
        0; // Mute Osc B (defaults to SINE at full volume!)
