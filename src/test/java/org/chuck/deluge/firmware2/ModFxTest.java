...
public class ModFxTest {
  ...
  public void testChorus() {
    ...
    processor.processModFX(buffer, 1024, ModFx.ModFXType.CHORUS, 100, 1 << 30, postFXVolume, 1 << 30, 0, false, true);
  ...
  public void testPhaser() {
    ...
    int[] postFXVolume = {1 << 30};
    processor.processModFX(buffer, 128, ModFx.ModFXType.PHASER, 100, 1 << 30, postFXVolume, 0, 1 << 30, false, true);
