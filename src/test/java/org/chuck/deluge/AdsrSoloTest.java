...
/**
 * Minimal ADSR diagnostic: SndBuf -> Adsr -> WvOut2 -> dac
 * No Pan2, no HPF, no Dyno, no complex tap chains.
 * Just the raw ADSR output to see if it works in a simple chain.
 */
