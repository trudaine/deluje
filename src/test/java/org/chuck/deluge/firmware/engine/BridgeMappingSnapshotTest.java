...
class BridgeMappingSnapshotTest {
  ...
  private org.chuck.deluge.firmware2.Sound buildRichSynth() {
  ...
  void bucketA_oneToOneCopies() {
    ...
    assertEquals(org.chuck.deluge.firmware2.Oscillator.OscType.SAW, fw2.oscTypes[0], "osc1 type");
    assertEquals(
        org.chuck.deluge.firmware2.Oscillator.OscType.SQUARE, fw2.oscTypes[1], "osc2 type");
    ...
    assertEquals(
        org.chuck.deluge.firmware2.Sound.PolyphonyMode.MONO, fw2.polyphonic, "polyphony mode");
    assertEquals(org.chuck.deluge.firmware2.ModFx.ModFXType.CHORUS, fw2.modFXType, "mod FX type");
  }
