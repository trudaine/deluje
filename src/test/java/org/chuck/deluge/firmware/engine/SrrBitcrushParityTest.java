...
public class SrrBitcrushParityTest {
  ...
  public void bitcrushZerosLowBits() {
    ...
    new org.chuck.deluge.firmware2.SrrBitcrush().process(buf, n, Integer.MAX_VALUE, OFF, postFX);
  ...
  public void bitcrushOffIsTransparent() {
    ...
    int[] postFX = {2147483647};
    new org.chuck.deluge.firmware2.SrrBitcrush().process(in, n, OFF, OFF, postFX);
    for (int i = 0; i < n; i++)
  ...
  public void srrHoldsSamples() {
    ...
    new org.chuck.deluge.firmware2.SrrBitcrush().process(wet, n, OFF, srr, postFX);
