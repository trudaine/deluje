...
structure of a real SD card preset (2.0.0-beta, proven to load), overriding only per-test fields.
...
def main():
    ...
    readme = [
        ...
        "SD card preset (proven to load on hardware), overriding only per-test fields — NOT via the",
